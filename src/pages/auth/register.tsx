                ...
                >
                  <div className="flex flex-col justify-center py-4 gap-2 w-[80%]">
                    ...
                    <button
                      ...
                      className="bg-[#d62243] hover:bg-[#ee0e42] cursor-pointer shadow-lg font-medium rounded-full py-1 mt-2 text-white w-full"
                    >
                    ...
                    <div className="text-sm text-center">
                      ...
                      <Link
                        to="/login"
                        className="text-[#d62243] hover:text-[#ec2151]"
                      >
                        Connectez-vous
                      </Link>
                    </div>
